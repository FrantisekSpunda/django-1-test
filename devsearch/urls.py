...
from django.contrib.auth import views as auth_views     # views for reset password
...
# Look at build in classes here: https://github.com/django/django/blob/main/django/contrib/auth/views.py